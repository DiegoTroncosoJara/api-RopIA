...
const ScanResult = sequelize.define('ScanResult', {
  ...
  wardrobe_item_id: { type: DataTypes.BIGINT.UNSIGNED, allowNull: true, references: { model: 'wardrobe_items', key: 'id' } },
  scan_type: { type: DataTypes.ENUM('new_item','condition_check','sustainability_check'), allowNull: false },
