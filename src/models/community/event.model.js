...
const Event = sequelize.define('Event', {
  ...
  organizer_id: { type: DataTypes.BIGINT.UNSIGNED, allowNull: false, references: { model: 'users', key: 'id' } },
  community_id: { type: DataTypes.BIGINT.UNSIGNED, allowNull: true, references: { model: 'communities', key: 'id' } },
  title: { type: DataTypes.STRING(255), allowNull: false },
  description: { type: DataTypes.TEXT, allowNull: false },
  category: { type: DataTypes.ENUM('workshop','lab','collective','course','meetup'), allowNull: false },
  ...
  skill_level: { type: DataTypes.ENUM('beginner','intermediate','advanced','all'), defaultValue: 'all' },
