...
const Biotextile = sequelize.define('Biotextile', {
  id: { type: DataTypes.BIGINT.UNSIGNED, autoIncrement: true, primaryKey: true },
  contributor_id: { type: DataTypes.BIGINT.UNSIGNED, allowNull: true, references: { model: 'users', key: 'id' } },
  ...
  water_resistance: { type: DataTypes.ENUM('none','low','medium','high'), defaultValue: 'none' },
